...
namespace VolumeControl.Library.Win32
{
    ...
    public static class PCWin32
    {
        ...
        [DllImport("winmm.dll", CharSet=CharSet.Ansi)]
        public static extern int mixerGetControlDetailsA(int hmxobj, ref VolumeStructs.MixerDetails pmxcd, uint fdwDetails);
        ...
        [DllImport("winmm.dll", CharSet=CharSet.Ansi)]
        public static extern int mixerOpen(out int phmx, uint uMxId, int dwCallback, int dwInstance, int fdwOpen);
